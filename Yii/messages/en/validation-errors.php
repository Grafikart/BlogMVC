...
return array(
    ...
    'post.restrictedSlug' => 'I\'m terribly sorry, but slug "{slug}" is restricted for usage.',
    'category.slugExists' => 'Slug "{slug}" is already used by another category.',
    'category.restrictedSlug' => 'I\'m terribly sorry, but slug "{slug}" is restricted for usage.',
    'user.incorrectPassword' => 'Your password didn\'t match the one in database',
    ...
    'app.configNotWritable' => 'Config {path} coud not be written.',
);