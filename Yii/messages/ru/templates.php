...
return array(
    ...
    'control.addNewF' => 'Добавить новую',
    ...
    'text.postsAmount' => '{n} запись|{n} записи|{n} записей|{n} записи',
    'text.commentsAmount' => '{n} комментарий|{n} комментария|{n} комментариев'.
        '|{n} комментария',
    ...
    'paragraph.serviceStatusCache' => 'Показываемые данные кэшируются и могут '.
        ...
        'кэш прямо сейчас:',
    'paragraph.userPostsAdminNotice' => 'Вы написали {postsAmount}, которые '.
        'получили {commentsAmount}. Вы можете управлять ими в '.
