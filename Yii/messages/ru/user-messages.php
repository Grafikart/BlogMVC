...
return array(
    ...
    'category.delete.success' => 'Категория "{categoryTitle}" была успешно ' .
        'удалена.',
    'category.delete.notEmpty' => 'Категория "{categoryTitle}" содержит ' .
        'записи и не может быть удалена.',
    'category.delete.doesNotExist' => 'Категория не существует и не может '.
        'быть удалена',
    'category.delete.fail' => 'Категорию "{categoryTitle}" не удалось ' .
        'удалить по неизвестной причине.',
